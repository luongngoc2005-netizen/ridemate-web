...
<section className="box"><div className="title"><h2>Bản đồ gợi ý</h2><button onClick={()=>directions(trip.origin,trip.destination)}>Mở Google Maps <ToolIcon name="external" className="inline-icon"/></button></div><iframe title="map" className="map" src={`https://www.google.com/maps?q=${encodeURIComponent(trip.destination)}&output=embed`}></iframe></section>
